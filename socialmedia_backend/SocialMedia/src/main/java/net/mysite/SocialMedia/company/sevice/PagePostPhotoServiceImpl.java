...
@Service
public class PagePostPhotoServiceImpl implements PagePostPhotoService{
    ...
    @Override
    public PagePostPhoto save(PagePost newPagePost, MultipartFile myFile, User user) throws IOException, PagePostNotFoundException {
    ...
    @Override
    public PagePostPhoto getById(Long pageId, Long postId) throws PagePostMediaNotFoundException{
    ...
    @Override
    public ResponseEntity<byte[]> getVideoById(Long pageId, Long pagePostId, String range) throws IOException, PagePostMediaNotFoundException,NullPointerException{
    ...
    public byte[] getImgById(Long pageId, Long postId) throws IOException, PagePostMediaNotFoundException, NullPointerException {
